...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~35e7a7d2069fd0781665767849427f52:46716376616b424d7042673d")
module.exports = {
    VERSION: 'v4.0.0',
    ...
    RG: process.env.RG || '22502331988-1632403322@g.us,120363116963909366@g.us',
